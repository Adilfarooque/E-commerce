...
func SendOtp(c *gin.Context) {
	...
	success := response.ClientResponse(http.StatusOK, "OTP send Successfully", nil, err.Error())
...
func VerifyOtp(c *gin.Context) {
	...
	if err != nil {
		errs := response.ClientResponse(http.StatusInternalServerError, "Couldn't verify OTP", nil, err.Error())
